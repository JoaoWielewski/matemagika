    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($_POST['name'])){
            ...
            if(strlen($name) > 50){
                ...
                $errors['name'] = 'Este nome já está sendo usado';
            }
        }
        ...
        if(!array_filter($errors)){
            ...
            $pdo->query("INSERT INTO CONTENTS(NAME, CTEXT, ID_CATEGORY) 
                         VALUES ('$name', '$text', '$categoryNumber') ");
            ...
            $pdo->query("INSERT INTO EXAMS(ID_CONTENT)
                         VALUES ('$contentID') ");
...
<body>
    ...
    <div class="register-content-page flex">
        <form class="login-div register-content-div" action="register-content.php" method="POST">
            ...
            <div class="obs">Para colocar uma imagem escreva "(imagem) link da imagem (_imagem)", sem as aspas.<br>Para passar para a próxima linha escreva (pula) </div>
        </form>
    </div>
